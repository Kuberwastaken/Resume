...
\begin{itemize}[leftmargin=0.15in]
  ...
  \item \textbf{CS50: Introduction to Computer Science} \hfill \textit{Harvard University }\\
  \begin{itemize}[leftmargin=0.2in]
    ...
    \item Solved real-world problem sets in domains like finance, cryptography, finance and gaming, enhancing problem-solving skills.
  \end{itemize}
\end{itemize}
...
\resumeSubheading
    {Concours Romain Rolland Olympiad}{Alliance Française de Normandie, France}
    {Gold Medalist}{}
    \resumeItemListStart
