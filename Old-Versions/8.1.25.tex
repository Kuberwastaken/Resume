...
\large
\resumeSubHeadingListStart
  \resumeItem{\href{https://github.com/Kuberwastaken/TREAT}{TREAT}}{Designed and implemented an Open-Source AI-driven web application using Flask and Python, leveraging Meta Llama-3.2 to analyze movie and TV show scripts for potential content triggers.}
  \resumeItem{\href{https://github.com/Kuberwastaken/ORCUS}{ORCUS}}{Developed an Open-Source dual-model AI system using RoBERTa-OpenAI-Detector and GPT-2 to identify and flag AI-generated social media comments to promote content authenticity on LinkedIn.}
