...
\large
\resumeSubHeadingListStart
  \resumeItem{\href{https://github.com/Kuberwastaken/TREAT}{TREAT}}{Developed and deployed a Gradio-based web app to analyze movie and show scripts for potential triggers, powered by Meta Llama-3.2, with an open-source model fully designed and built by me.}
